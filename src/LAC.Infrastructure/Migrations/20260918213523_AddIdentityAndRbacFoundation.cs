...
{
    /// <inheritdoc />
    public partial class AddIdentityAndRbacFoundation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScopeMode = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "UserWorkstreamMemberships",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserWorkstreamMemberships", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserWorkstreamMemberships_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserWorkstreamMemberships_Workstreams_WorkstreamId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserWorkstreamMemberships_UserId_WorkstreamId",
                table: "UserWorkstreamMemberships",
                columns: new[] { "UserId", "WorkstreamId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserWorkstreamMemberships_WorkstreamId",
                table: "UserWorkstreamMemberships",
                column: "WorkstreamId");

            migrationBuilder.CreateIndex(
                name: "IX_Workstreams_Code",
                table: "Workstreams",
                column: "Code",
                unique: true);
        }
