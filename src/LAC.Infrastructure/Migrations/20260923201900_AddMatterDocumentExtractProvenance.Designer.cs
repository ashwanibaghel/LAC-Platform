...
namespace LAC.Infrastructure.Migrations
{
    ...
    [Migration("20260923201900_AddMatterDocumentExtractProvenance")]
    partial class AddMatterDocumentExtractProvenance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LAC.Domain.CourtCase", b =>
                {
                    ...
                    b.HasIndex("DisposedDate");

                    b.HasIndex("FiledDate");

                    b.HasIndex("ResponsibleOfficeDeskId");

                    b.ToTable("CourtCases", null, t =>
                        {
                            t.HasCheckConstraint("CK_CourtCases_DisposedDate_After_FiledDate", "\"DisposedDate\" IS NULL OR \"FiledDate\" IS NULL OR \"DisposedDate\" >= \"FiledDate\"");
                        });
                });
            ...
            modelBuilder.Entity("LAC.Domain.CourtCaseDocument", b =>
                {
                    ...
                    b.HasIndex("CourtCaseId", "DocumentId")
                        .IsUnique()
            ...
            modelBuilder.Entity("LAC.Domain.CourtCaseEvent", b =>
                {
                    ...
                    b.Property<string>("CaseNumberSnapshot")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");

                    b.Property<string>("CaseTitleSnapshot")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<Guid?>("CourtCasePartyId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("CourtCaseRepresentativeId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LAC.Domain.CourtCaseMatter", b =>
                {
                    ...
                    b.HasIndex("CourtCaseId", "MatterId")
                        .IsUnique()
                        .HasFilter("\"RecordStatus\" = 'Active'");
            ...
            modelBuilder.Entity("LAC.Domain.CourtCaseRepresentative", b =>
                {
                    ...
                    b.Property<string>("RepresentsRole")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("LAC.Domain.MatterDocumentExtract", b =>
                {
                    ...
                    b.Property<Guid>("ExtractedByUserId")
                        .HasColumnType("uuid");

                    b.Property<string>("ExtractedByUserNameSnapshot")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("NormalizedPageNumbersJson")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("NormalizedSourcePagesText")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("SourceSha256Hash")
                        .HasColumnType("text");

                    b.HasKey("Id");

                    b.HasIndex("ExtractedByUserId");

                    b.HasIndex("MatterDocumentId")
                        .IsUnique();
            ...
            modelBuilder.Entity("LAC.Domain.CourtCaseRepresentative", b =>
                {
                    ...
                    b.HasOne("LAC.Domain.CourtCaseParty", "CourtCaseParty")
                        .WithMany()
                        .HasForeignKey("CourtCasePartyId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("CourtCase");

                    b.Navigation("CourtCaseParty");
                });
            ...
            modelBuilder.Entity("LAC.Domain.MatterDocumentExtract", b =>
                {
                    b.HasOne("LAC.Domain.AppUser", "ExtractedByUser")
                        .WithMany()
                        .HasForeignKey("ExtractedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LAC.Domain.MatterDocument", "MatterDocument")
                        .WithOne("ExtractProvenance")
                        .HasForeignKey("LAC.Domain.MatterDocumentExtract", "MatterDocumentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("ExtractedByUser");

                    b.Navigation("MatterDocument");
            ...
            modelBuilder.Entity("LAC.Domain.MatterDocument", b =>
                {
                    b.Navigation("ExtractProvenance");
                });
